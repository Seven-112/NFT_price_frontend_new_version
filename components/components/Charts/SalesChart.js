...
const SalesChart = (props) => {
    useEffect(() => {
        (async () => {
            ...
            toolTip.style = `width: 150px; height: 88px; position: absolute; display: none; padding: 10px; box-sizing: border-box; font-size: 12px; text-align: left; z-index: 999; top: 12px; left: 12px; pointer-events: none; border: 1px solid; border-radius: 5px;font-family: 'Trebuchet MS', Roboto, Ubuntu, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;`
