                ...
                <div className="col-lg-7">
                  <div className="d-desc ml-5">
                    ...
                    <div className="d-flex mobile-flex-wrap">
                      <CustomStat background="#DCF2FF" amount={this.props.soldNFTs ? this.props.soldNFTs : "---"} description="Number of NFTs sold" timestamp="Last 24 hours" />
                      <CustomStat background="#FFF1DC" icon="ether" amount={this.props.volumeNFTs ? this.props.volumeNFTs : "---"} description="Trading Volume" timestamp="Last 24 hours" />
